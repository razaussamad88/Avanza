...
namespace Vision.Web.Common
{
    ...
    {
        public static string licenseKey = "f0fa9c8a95b7e35327c8277d54a7257e";
        ...
        public bool AESEncrypt(string sClearTxt, ref string sEncryptTxt, string sKey)
        {
            ...
            using (AesManaged aesAlg = new AesManaged())
            {
                ...
                aesAlg.Key = ASCIIEncoding.GetEncoding("iso-8859-1").GetBytes(sKey);

                //Set initialization vector.
                //aesAlg.IV = ASCIIEncoding.GetEncoding("iso-8859-1").GetBytes(sKey);
                ...
                using (MemoryStream msEncrypt = new MemoryStream())
                {
                    using (CryptoStream csEncrypt = new CryptoStream(msEncrypt, encryptor, CryptoStreamMode.Write))
                    {
                        ...
                        //sEncryptTxt = ASCIIEncoding.GetEncoding("iso-8859-1").GetString(encrypted);
        ...
        public bool AESDecrypt(string sEncrptTxt, ref string sClearTxt, string sKey)
        {
            ...
            using (AesManaged aesAlg = new AesManaged())
            {
                ...
                //encrypted = ASCIIEncoding.GetEncoding("iso-8859-1").GetBytes(sEncrptTxt);
