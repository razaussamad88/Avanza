...
REM *****  SET FILE NAME  *************************
set "impBasePath=D:\OrcaleExportedDatabases\"
set "filename=MPG_VISIONWEB_20220112_120827.dmp"
REM ***********************************************
...
set "impFilePath=%impBasePath%%filename%%fullstamp%.dmp"
set "impLogFilePath=%impBasePath%%filename%.log"
...
imp MPG_VISIONWEB/vision@ORCL_LOCAL_xx127 file='%impFilePath%'  log='%impLogFilePath%' owner=MPG_VISIONWEB
...
REM exp VISION_MIGRATION2/VISION_MIGRATION2@localhost:1521/orcl file='%impFilePath%'  log='%impLogFilePath%' owner=VISION_MIGRATION2 
REM exp Vision_Web2/Vision_Web2@localhost:1521/orcl file='%impFilePath%'  log='%impLogFilePath%' owner=Vision_Web2 constraints=n indexes=n statistics=none
