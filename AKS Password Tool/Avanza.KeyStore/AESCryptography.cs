...
namespace Avanza.KeyStore
{
    ...
    {
        public static string licenseKey = "zlAhtcug/DQX4RRTSctuAnyGntq0Ng+e9N0YXgPb044=";
        private static AESCryptography m_Instance = null;

        public static AESCryptography Instance
        {
            get
            {
                if (m_Instance == null)
                {
                    m_Instance = new AESCryptography();
                }
