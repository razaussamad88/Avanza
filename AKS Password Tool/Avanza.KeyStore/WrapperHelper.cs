...
namespace Avanza.KeyStore
{
    ...
    public enum PasswordManagerOpCode { CHANGE_CON_STR = 1, CHANGE_SWITCH_CONFIG_CONN_STR, RESET_KEK_DEK, RESET_DEK = 4 };
     ...
     * BackOffice	:	4
     */
    public enum ProductIndex { Rendezvous = 1, Nimbus, RDVSM, BackOffice };
    ...
    public class WrapperHelper
    {
        ...
        public static string PRODUCT_MESSAGE_FORMAT = "{0}" + KEYSTORE_FIELD_SEPERATOR + "{1}";
