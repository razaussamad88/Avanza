...
namespace Avanza.Core.AvanzaKeyStore
{
    public class KeyStoreWrapper
    {
        ...
        private static KeyStoreWrapper _Singleton;
        
        private static Logger logger = LogManager.GetLogger(typeof(KeyStoreWrapper).FullName);
        #endregion

        #region Properties
        public static KeyStoreWrapper Instance
        {
            get
            {
                if (_Singleton == null)
        ...
        public KeyStoreWrapper(string KeystoreIP, int KeystorePort, string CertificatePath)
        {
        ...
        public static void Create()
        {
            ...
            //_Singleton = new KeyStoreWrapper();
            if (_Singleton == null)
            {
                _Singleton = new KeyStoreWrapper();
            }
        ...
        public static void Create(string KeystoreIP, int KeystorePort, string CertificatePath)
        {
            ...
            //_Singleton = new KeyStoreWrapper(KeystoreIP, KeystorePort, CertificatePath);
        ...
        //private string SendRequest(KeyStoreOpCode opCode, string productIndex, string data)
        //{
        //    return SendRequest(opCode, (ProductIndex)Enum.Parse(typeof(ProductIndex), productIndex), data);
        //}
